...
import 'package:smart_keslassi_parent/utils/paiement_controller.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              const Text("USD", style: TextStyle(fontSize: 13)),
              // Expanded(
              //   flex: 5,
              //   child: RadioListTile(
              ...
              //   flex: 5,
              //   child: RadioListTile(
              //     title: const Text("CDF", style: TextStyle(fontSize: 13)),
              //     value: "CDF",
              //     groupValue: gender,
              //     onChanged: (value) {
              //       setState(() {
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (numero.text.length == 9) {
                ...
                //
                PaieController paiementController = Get.find();
                //
                Get.dialog(
                  const Material(
